...
async function postCarrito(req, res) {
    try {
        ...
        const item = {
            nombre: descripcionProd.nombre,
            cantidad: cantidad,
            precio_unitario: descripcionProd.precio,
            Total: (descripcionProd.precio) * cantidad
        }
        ...
        if (prodsCarrito == null) {
            ...
            const prodsCarritos = await carritoDAO.getByUser(usuario)
        ...
        const itemDuplicado = {
            nombre: descripcionProd.nombre,
            cantidad: nombreProd.cantidad + cantidad,
            precio_unitario: descripcionProd.precio,
            Total: (descripcionProd.precio) * cantidad + nombreProd.Total
        }
